...
const Home = () => {
    ...
    return (
        <>
            <Nav />
            {/* Hero Section */}
            <section id="hero" className="w-full h-[92vh] relative flex flex-col justify-center items-center overflow-hidden">
...
<Link to="/login">                    <button type="button" class="text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 shadow-lg shadow-teal-500/50 dark:shadow-lg dark:shadow-teal-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 cursor-pointer">Book Now</button>
</Link>                </div>
                    ...
                    <div className="mb-12">
                        ...
                        <div className="flex justify-center gap-4 flex-wrap ">
                            {[
                                ...
                                <div key={index} className="p-2 bg-white rounded shadow w-36 sm:w-40 hover:scale-105 transition transform duration-300 flex flex-col">
                                    ...
                                    <h4 className="text-md sm:text-lg font-semibold text-center">{service.name}</h4>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8 sm:gap-12 px-4">
                    <div className="md:w-1/2 text-center md:text-left">
                        ...
                        <p className="text-gray-600 text-sm sm:text-base font-semibold">
                            “Welcome to <strong className="text-red-600">SalonEase</strong>, your one-stop destination for connecting customers with the best salons and beauty services nearby. Our platform is designed to make booking salon services quick, simple, and hassle-free.

                            For users, we offer an easy way to browse through trusted salons, view available services, and schedule appointments at their convenience. For salon owners, we provide tools to manage bookings, showcase services, and grow their business with a wider customer base.

                            We believe beauty and self-care should be accessible to everyone. With <strong className="text-red-600">SalonEase</strong>, you can find the right service, at the right time, with the best professionals — all in one place.”
                        </p>
                    </div>
